...
const contactMethods = [
  {
    title: "Email support",
    value: "support@omnitech.dev",
    href: "mailto:support@omnitech.dev",
    description: "For app help, billing, and technical questions.",
  },
  {
    title: "General inquiries",
    value: "hello@omnitech.dev",
    href: "mailto:hello@omnitech.dev",
    description: "Partnerships, custom apps, and business inquiries.",
  },
  {
    title: "Response time",
    value: "Within 24 hours",
    href: null,
    description: "We reply on business days (Mon–Fri).",
  },
];
              ...
              <FadeIn delay={0.3}>
                <div className="mt-6 rounded-2xl border border-border bg-gradient-to-br from-shopify-dark to-accent p-6 text-white">
                  ...
                  <p className="mt-2 text-sm text-emerald-100">
                    We build private and public apps for agencies and brands.
                    Describe your project in the contact form.
                  </p>
                </div>
              </FadeIn>
            </div>
